...
public class frmPizza {
    ...
    private void initComponents() {
        ...
        jPanelPrincipal.setBackground(new Color(25, 223, 186));
        //Fondo de color
        JPanel northPanel = new JPanel(new FlowLayout());
        northPanel.setBackground(new Color(25, 93, 11));
        // Encabezado
        ...
        btnPrepararPizza.setBackground(new Color(20, 40, 40));
        // Color de fondo del botón resaltado
        btnPrepararPizza.setForeground(Color.WHITE);
        ...
        northPanel.add(btnPrepararPizza);
        //Boton Preparar Pizza
    ...
    private void loadEspecialidades() {
        ...
        specialPizzaIngredients.put("Mariscos", "Camarones, Pedazos de Aleta de Tiburon, Filete de Pescado");
        specialPizzaIngredients.put("Vegetariana", "Chile Dulce, Gitomates, Zanahoria, Queso");
        specialPizzaIngredients.put("Italiana", "Tomate, Mozzarella, Albahaca");
        specialPizzaIngredients.put("Mexicana", "Carne Molida, Salsa Brava, Pico de Gallo, Queso");
    }
